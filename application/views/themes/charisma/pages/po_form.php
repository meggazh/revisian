        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo site_url('quotation/save_master');?>" id="form-quotation">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label label-custom">No Info Order</label>
                        <div class="col-sm-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                                <select class="form-control" id="customer" data-placeholder="Select No Quotation" name="customer">
                                   <option value=""></option>
                                </select>
                        </div>
                        </div>
                ...
                <hr>
                        ...
                        <div class="form-group">
                        <label class="col-sm-2 control-label label-custom">No Quotation</label>
                        <label class="col-sm-5 control-label label-custom text-info" id="no_quo"></label>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label label-custom">Date</label>
                        <label class="col-sm-5 control-label label-custom text-info" id="date"></label>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label label-custom">Term</label>
                        <label class="col-sm-5 control-label label-custom text-info" id="term"></label>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label label-custom">Discount</label>
                        <label class="col-sm-5 control-label label-custom text-info" id="discount"></label>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label label-custom">Remarks</label>
                        <label class="col-sm-5 control-label label-custom text-info" id="remarks"></label>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label label-custom">PPN</label>
                        <label class="col-sm-5 control-label label-custom text-info" id="ppn"></label>
                    </div>
                    <hr>
                ...
                <div class="box-footer">
                    ...
                    <button class="btn btn-success" type="submit">Save PO</button>
                </div>
                </form>
            </div>
        </div>
