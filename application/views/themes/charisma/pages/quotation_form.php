...
// numbering format
    ...
    $("#form-quotation").submit(function(event) {
        ...
        $.each( oTable.fnGetData(), function(i, row){
			  ...
			  secondCellArray.push(row[4]); //index 2        //    
			  secondCellArray.push(row[5]); //index 3
              secondCellArray.push(row[6]); //index 4
              secondCellArray.push(row[7]); //index 5
              secondCellArray.push(row[8]); //index 6
              secondCellArray.push(row[9]); //index 7
...
function addList() {//pengaturan field di data table
