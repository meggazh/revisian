	...
	**/
	...
	public function save_detail()
	{
		...
		foreach($post as $key => $value){
			...
			$data[] = array(
				'TxnQuotDtlID'  		=> null,
				'TxnQuotDtlQty' 		=> $value[4],//3
				'TxnQuotDtlUnitPrice'	=> $value[3],//2
				'TxnQuotDtlDiscAm'    	=> $value[5],//4
				'TxnQuotsize'			=> $value[2],				
				'TxnQuotDtlDiscPrs'     => $value[6],//5
				'TxnQuotDtlTotAm'		=> $value[7],//6
				'TxnQuotDtlRemarks'		=> $value[8],//7
				'MstChasID'				=> $value[0],//0
				'MstProductID'			=> $value[1],//1
